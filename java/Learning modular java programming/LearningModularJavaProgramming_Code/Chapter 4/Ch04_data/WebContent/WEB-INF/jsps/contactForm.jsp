	...
	<form:form modelAttribute="contact" method="POST" action="addContact.htm">
		...
		<table width="100%" height="150" align="center" border="0">
			<tr>
				...
				<td width="50%" align="left"><form:input path="firstName" size="30" />
			...
			<tr>
				...
				<td width="50%" align="left"><form:input path="phone_number"	size="30" />
				<font color="red"><form:errors path="phone_number" /></font>
				</td>
			</tr>
